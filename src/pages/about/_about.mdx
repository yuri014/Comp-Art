...
Nos grupos e fandoms, os apreciadores poderão postar. Ambos têm limitações de participantes.
...
Muitas dessas funcionalidades ainda não foram implementadas, mas serão implementadas assim que tivermos recursos.
